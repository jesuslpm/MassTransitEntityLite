...
namespace Sample.Components
{
	...
	[Serializable]
	[DataContract]
	[SqlEntity(BaseTableName="registration_states")]
	public partial class RegistrationState
	{
		private Guid _correlationId;
		[DataMember]
		[SqlField(DbType.Guid, 16, IsKey=true, ColumnName ="correlation_id", BaseColumnName ="correlation_id", BaseTableName = "registration_states" )]		
		...
		private DateTime _registrationDate;
		[DataMember]
		[SqlField(DbType.DateTime2, 8, Scale=7, ColumnName ="registration_date", BaseColumnName ="registration_date", BaseTableName = "registration_states" )]		
		public DateTime RegistrationDate 
		{ 
		    get { return _registrationDate; } 
			set 
		...
		private String _memberId;
		[DataMember]
		[SqlField(DbType.String, 64, ColumnName ="member_id", BaseColumnName ="member_id", BaseTableName = "registration_states" )]		
		public String MemberId 
		{ 
		    get { return _memberId; } 
			set 
		...
		private String _eventId;
		[DataMember]
		[SqlField(DbType.String, 64, ColumnName ="event_id", BaseColumnName ="event_id", BaseTableName = "registration_states" )]		
		public String EventId 
		{ 
		    get { return _eventId; } 
			set 
		...
		private Decimal _payment;
		[DataMember]
		[SqlField(DbType.Decimal, 17, Precision = 18, Scale=2, ColumnName ="payment", BaseColumnName ="payment", BaseTableName = "registration_states" )]		
		public Decimal Payment 
		{ 
		    get { return _payment; } 
			set 
		...
		[DataMember]
		[SqlField(DbType.String, 64, ColumnName ="current_state", BaseColumnName ="current_state", BaseTableName = "registration_states" )]		
	...
	public partial class RegistrationStateRepository : Repository<RegistrationState> 
	{
		public RegistrationStateRepository(DataService DataService) : base(DataService)
		{
		}
		...
		public RegistrationState Get(string projectionName, Guid correlationId)
		{
			return ((IRepository<RegistrationState>)this).Get(projectionName, correlationId, FetchMode.UseIdentityMap);
		}

		public RegistrationState Get(string projectionName, Guid correlationId, FetchMode fetchMode = FetchMode.UseIdentityMap)
		{
			return ((IRepository<RegistrationState>)this).Get(projectionName, correlationId, fetchMode);
		}

		public RegistrationState Get(Projection projection, Guid correlationId)
		{
			return ((IRepository<RegistrationState>)this).Get(projection, correlationId, FetchMode.UseIdentityMap);
		}

		public RegistrationState Get(Projection projection, Guid correlationId, FetchMode fetchMode = FetchMode.UseIdentityMap)
		{
			return ((IRepository<RegistrationState>)this).Get(projection, correlationId, fetchMode);
		}

		public RegistrationState Get(string projectionName, Guid correlationId, params string[] fields)
		{
			return ((IRepository<RegistrationState>)this).Get(projectionName, correlationId, fields);
		}

		public RegistrationState Get(Projection projection, Guid correlationId, params string[] fields)
		{
			return ((IRepository<RegistrationState>)this).Get(projection, correlationId, fields);
		}

		public bool Delete(Guid correlationId)
		{
			var entity = new RegistrationState { CorrelationId = correlationId };
			return this.Delete(entity);
		}

				// asyncrhonous methods

		public System.Threading.Tasks.Task<RegistrationState> GetAsync(string projectionName, Guid correlationId)
		{
			return ((IRepository<RegistrationState>)this).GetAsync(projectionName, correlationId, FetchMode.UseIdentityMap);
		}

		public System.Threading.Tasks.Task<RegistrationState> GetAsync(string projectionName, Guid correlationId, FetchMode fetchMode = FetchMode.UseIdentityMap)
		{
			return ((IRepository<RegistrationState>)this).GetAsync(projectionName, correlationId, fetchMode);
		}

		public System.Threading.Tasks.Task<RegistrationState> GetAsync(Projection projection, Guid correlationId)
		{
			return ((IRepository<RegistrationState>)this).GetAsync(projection, correlationId, FetchMode.UseIdentityMap);
		}

		public System.Threading.Tasks.Task<RegistrationState> GetAsync(Projection projection, Guid correlationId, FetchMode fetchMode = FetchMode.UseIdentityMap)
		{
			return ((IRepository<RegistrationState>)this).GetAsync(projection, correlationId, fetchMode);
		}

		public System.Threading.Tasks.Task<RegistrationState> GetAsync(string projectionName, Guid correlationId, params string[] fields)
		{
			return ((IRepository<RegistrationState>)this).GetAsync(projectionName, correlationId, fields);
		}

		public System.Threading.Tasks.Task<RegistrationState> GetAsync(Projection projection, Guid correlationId, params string[] fields)
		{
			return ((IRepository<RegistrationState>)this).GetAsync(projection, correlationId, fields);
		}

		public System.Threading.Tasks.Task<bool> DeleteAsync(Guid correlationId)
		{
			var entity = new RegistrationState { CorrelationId = correlationId };
			return this.DeleteAsync(entity);
		}
	...
	// [Obsolete("Use nameof instead")]
	public static partial class RegistrationStateFields
	{
	...
	public static partial class RegistrationStateProjections
	{
		public const string BaseTable = "BaseTable";
	}
}
...
namespace Sample.Components
{
	public partial class RegistrationDataService : DataService
	{
		...
		private Sample.Components.RegistrationStateRepository _RegistrationStateRepository;
		public Sample.Components.RegistrationStateRepository RegistrationStateRepository
		{
			get 
			{
				if ( _RegistrationStateRepository == null)
				{
					_RegistrationStateRepository = new Sample.Components.RegistrationStateRepository(this);
				}
				return _RegistrationStateRepository;
			}
		}
	}
}
